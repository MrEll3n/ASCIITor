    ...
    for i in range(len(map)):
        for j in range(len(map[i])):
            ...
            if map[i][j] < -0.5:
                ...
                map[i][j] = " " # .
            elif map[i][j] >= -0.3 and map[i][j] < -0.2:
                map[i][j] = " " # -
            elif map[i][j] >= -0.2 and map[i][j] < -0.1:
                map[i][j] = " " # -
            elif map[i][j] >= -0.1 and map[i][j] < 0:
                map[i][j] = " " # =
            elif map[i][j] >= 0 and map[i][j] < 0.1:
                map[i][j] = "." # +
            elif map[i][j] >= 0.1 and map[i][j] < 0.2:
                map[i][j] = ":" # *
            elif map[i][j] >= 0.2 and map[i][j] < 0.3:
                map[i][j] = "#" # #
            elif map[i][j] >= 0.3 and map[i][j] < 0.4:
                map[i][j] = " " # %
            elif map[i][j] >= 0.4 and map[i][j] < 0.5:
                map[i][j] = " " # @
            elif map[i][j] > 0.5:
                map[i][j] = " " # @
    ...
    while True:
        ...
        try:
            ...
            if key == "KEY_LEFT":
                ...
                #if p.x > CAM_WIDTH // 2 and move_cam and CAM_X < GAME_X - CAM_WIDTH - 1:
                #    CAM_X -= 1
                ...
                #if CAM_X < GAME_X - CAM_WIDTH - 1 and move_cam:
                #    CAM_X += 1
                ...
                #if CAM_Y < GAME_Y - CAM_HEIGHT - 1 and move_cam:
                #    CAM_Y += 1
